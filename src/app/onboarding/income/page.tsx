...
const sources = [
  { id: "w2", icon: Building2, label: "W-2 Employment", description: "Traditional employer", color: "text-brand-blue" },
  { id: "self", icon: Briefcase, label: "Self-Employed", description: "1099 / freelance", color: "text-brand-green" },
  { id: "retirement", icon: Landmark, label: "Retirement", description: "Pension, Social Security", color: "text-violet" },
  { id: "investments", icon: TrendingUp, label: "Investments", description: "Capital gains, dividends", color: "text-teal" },
  { id: "other", icon: MoreHorizontal, label: "Other", description: "Rental, gig work, etc.", color: "text-muted" },
];
...
export default function IncomePage() {
  ...
  return (
    <AppShell hideNav>
      ...
      <ProgressBar value={75} steps="Step 6 of 8" />
              ...
              <div key={source.id} className={`animate-fade-up delay-${i + 2}`}>
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={`flex items-center justify-center w-10 h-10 rounded-xl bg-surface-alt ${source.color}`}>
                      <Icon size={20} />
                    </div>

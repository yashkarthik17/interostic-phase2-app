...
import { AppShell, ScreenContent, FormInput, Button, Card } from "@/components/ui/shell";
...
export default function LoginPage() {
  ...
  return (
    <AppShell hideNav>
      <ScreenContent className="flex flex-col justify-center py-8 sm:py-12">
        {/* Logo */}
        ...
        {/* Divider */}
        <div className="animate-fade-up delay-3 flex items-center gap-3 mb-6">
        ...
        <div className="animate-fade-up delay-4 flex gap-3 mb-8">
          <button className="flex-1 flex items-center justify-center gap-2 py-3.5 bg-white border-[1.5px] border-border rounded-xl text-sm font-semibold text-navy shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-lift)] hover:border-border-strong transition-all duration-200 active:scale-[0.97]">
